...
public:
    ...
    HMatrixImpl(htool::VirtualGeneratorInUserNumbering<K> &mat, std::shared_ptr<htool::Cluster<double>> t, std::shared_ptr<htool::Cluster<double>> s,const htool::HMatrixTreeBuilder<K,double>& hmatrix_tree_builder,MPI_Comm comm) : target_cluster(t), source_cluster(s), distributed_operator_holder(mat,*target_cluster,*source_cluster,hmatrix_tree_builder,comm),distributed_operator(distributed_operator_holder.distributed_operator), H(distributed_operator_holder.hmatrix), infos(htool::get_distributed_hmatrix_information(H,distributed_operator.get_comm())){}
...
template <class R>
void buildHmat(HMatrixVirt<R>** Hmat, htool::VirtualGeneratorInUserNumbering<R>* generatorP,const Data_Bem_Solver& data,
...
void creationHMatrixtoBEMForm(const FESpace1 * Uh, const FESpace2 * Vh, const int & VFBEM, 
    ...
    */
    ...
    if (VFBEM==1) {
        ...
        htool::VirtualGeneratorInUserNumbering<R>* generator;
