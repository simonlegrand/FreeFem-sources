...
template<class K>
class MyMatrix: public VirtualGeneratorInUserNumbering<K>{
        const KNM<K> &M;

public:
        MyMatrix(const KNM<K> &mat):VirtualGeneratorInUserNumbering<K>(),M(mat) {}
...
class OpHMatrixUser : public OneOperator
{
    public:
        ...
        OpHMatrixUser() :
        OneOperator(atype<const typename OpHMatrixUser<R,v_fes1,v_fes2>::Op*>(),atype<VirtualGeneratorInUserNumbering<R>**>(),atype<pfes1*>(),atype<pfes2*>()) {}
};
...
AnyType SetOpHMatrixUser(Stack stack,Expression emat, Expression eop)
{
    ...
    *Hmat =0;
    ...
    VirtualGeneratorInUserNumbering<R>** generator = GetAny<VirtualGeneratorInUserNumbering<R>**>((*op->g)(stack));
...
//    Global.Add("Potential","(",new FormalBemPotential);
    ...
    Dcl_TypeandPtr< VirtualGeneratorInUserNumbering<double>* >(0, 0,::InitializePtr< VirtualGeneratorInUserNumbering<double>* >, ::DeletePtr< VirtualGeneratorInUserNumbering<double>*> );
    Dcl_TypeandPtr< VirtualGeneratorInUserNumbering<std::complex<double>>* >(0, 0,::InitializePtr< VirtualGeneratorInUserNumbering<std::complex<double>>* >, ::DeletePtr< VirtualGeneratorInUserNumbering<std::complex<double>>*> );
    zzzfff->Add("Generator", atype<VirtualGeneratorInUserNumbering<double>** >( ));
    map_type_of_map[make_pair(atype<VirtualGeneratorInUserNumbering<double>**>(), atype<double*>())] = atype<VirtualGeneratorInUserNumbering<double>**>();
    map_type_of_map[make_pair(atype<VirtualGeneratorInUserNumbering<double>**>(), atype<Complex*>())] = atype<VirtualGeneratorInUserNumbering<std::complex<double> >**>();
